...
$address = get_option("of_contact_form_email");
...
if (trim($subject) == '') {
    $error .= '<li>A topic is required.</li>';
}
...
if ($error != '') {
    ...
    $msg .= "-------------------------------------------------------------------------------------------" . PHP_EOL;
    $msg .= "This message was sent to you from Contact Form";
    ...
    $headers = "From: wordpress@mtpc.govspace.gov.au" . PHP_EOL;
