...
Here at Jigowatt, we use a selection of Mac Desktops and Macbooks, occasionally Windows doesn't like the Files we zip up! If your download seems corrupt don't worry, please contact themeforest@jigowatt.co.uk and we'll send over a fresh copy of them for you.
...
If you don't fancy merging the two, make sure you open up the file style/contact.css and Remove the body and html css tags so they don't conflict with your existing ones! (See Optional Step 6)
...
31/08/2010 - 1.1 Released. Added utf-8 support.
23/09/2010 - 1.2 Released. OAuth added so twitter DM's work. Requires configuration.
11/03/2011 - 1.3 Released. Improvements to the image verification.
11/04/2011 - 1.4 Released. Cookie fallback for verification. 
