...
(function(b, ib) {
    ...
    function db(c) {
        if (!O) {
            ...
            if (!u) {
                ...
                d.position(0);
                X && n.bind(v + P + " scroll." + P,
                        function() {
                            x.css({width:n.width(),height:n.height(),top:n.scrollTop(),left:n.scrollLeft()})
                        }).trigger("scroll." + P);
                w(fb, a.onOpen);
    ...
    d.position = function(f, d) {
        ...
        j.dequeue().animate({width:a.w + z,height:a.h + y,top:h,left:g}, {duration:e,complete:function() {
                    b(this);
                    E = c;
    ...
    d.prep = function(o) {
        ...
        if (u) {
            ...
            k.remove();
            k = f(M).html(o);
            k.hide().appendTo(J.show()).css({width:function() {
                a.w = a.w || k.width();
                a.w = a.mw && a.mw < a.w ? a.mw : a.w;
                return a.w
            }(),overflow:a.scrolling ? q : e}).css({height:function() {
                a.h = a.h || k.height();
            ...
            X && b("select").not(j.find("select")).filter(
                    function() {
    ...
    d.load = function(u) {
        ...
        if (a.inline) {
            ...
            c.onload = function() {
                ...
                h[1] && (g < h.length - 1 || a.loop) && b(c).css({cursor:"pointer"}).click(d.next);
