...
(function(c) {
    c.anythingSlider = function(h, i) {
        ...
        a.init = function() {
            ...
            a.easingMargin = a.options.easing.match("swing|linear") ? 0 : 100;
            a.$el.css("margin-left", a.easingMargin + "px");
        ...
        a.updateSlider = function() {
            ...
            a.options.infiniteSlides && (a.$el.prepend(a.$items.filter(":last").clone().addClass("cloned").removeAttr("id")),a.$el.append(a.$items.filter(":first").clone().addClass("cloned").removeAttr("id")),a.$el.find("li.cloned").each(function() {
                c(this).find("a").attr("disabled", "disabled");
            ...
            a.hasEmb && a.hasSwfo && a.$items.find("embed[src*=youtube]").each(function(b) {
                ...
                swfobject.embedSWF(c(this).attr("src") + "&enablejsapi=1&version=3&playerapiid=ytvideo" + b, "ytvideo" + b, e.attr("width"), e.attr("height"), "10", null, null, {allowScriptAccess:"always",wmode:a.options.addWmodeToObject,allowfullscreen:!0}, {"class":e.attr("class"),style:e.attr("style")}, function() {
        ...
        a.buildNavigation = function() {
            ...
            a.options.buildNavigation && a.pages > 1 && a.$items.filter(":not(.cloned)").each(function(f) {
                ...
                c.isFunction(a.options.navigationFormatter) ? (b = a.options.navigationFormatter(g, c(this)),d.html("<span>" + b + "</span>"),parseInt(d.find("span").css("text-indent"), 10) < 0 && d.addClass(a.options.tooltipClass).attr("title", b)) : d.html("<span>" + g + "</span>");
        ...
        a.buildNextBackButtons = function() {
            if (!a.$forward)a.$forward = c('<span class="arrow forward"><a href="#"><span>' + a.options.forwardText + "</span></a></span>"),a.$back = c('<span class="arrow back"><a href="#"><span>' + a.options.backText + "</span></a></span>"),a.$back.bind(a.options.clickArrows, function(b) {
                a.goBack();
                b.preventDefault()
        ...
        a.buildAutoPlay = function() {
            if (!a.$startStop)a.$startStop = c("<a href='#' class='start-stop'></a>").html("<span>" + (a.playing ? a.options.stopText : a.options.startText) + "</span>"),a.$controls.prepend(a.$startStop),a.$startStop.bind(a.options.clickSlideshow,
                    function(b) {
        ...
        a.setDimensions = function() {
            var b,e,d,f,g,h = a.easingMargin,i = a.$window.width(),j = a.$win.width();
        ...
        a.setCurrentPage = function(b, e) {
            ...
            e || (a.$wrapper.css({width:a.panelSize[a.options.infiniteSlides ? b : b - 1][0],height:a.panelSize[a.options.infiniteSlides ? b : b - 1][1]}),a.$wrapper.scrollLeft(0),a.$window.scrollLeft(a.panelSize[a.options.infiniteSlides ? b : b - 1][2]));
            a.currentPage = b;
        ...
        a.setHash = function(b) {
            var c = "panel" + a.runTimes + "-",d = a.win.location.hash;
            if (typeof d !== "undefined")a.win.location.hash = d.indexOf(c) > 0 ? d.replace(a.regex, c + b) : d + "&" + c + b
        };
        a.slideControls = function(b) {
            var c = b ? 0 : a.options.animationTime,d = b ? a.options.animationTime : 0,f = b ? 1 : 0,g = b ? 0 : 1;
        ...
        a.startStop = function(b, c) {
            b !== !0 && (b = !1);
            if (b && !c)a.$el.trigger("slideshow_start", a),a.slideshow = !0;
            a.playing = b;
            a.options.autoPlay && (a.$startStop.toggleClass("playing", b).html("<span>" + (b ? a.options.stopText : a.options.startText) + "</span>"),parseInt(a.$startStop.find("span").css("text-indent"), 10) < 0 && a.$startStop.addClass(a.options.tooltipClass).attr("title", b ? "Stop" : "Start"));
