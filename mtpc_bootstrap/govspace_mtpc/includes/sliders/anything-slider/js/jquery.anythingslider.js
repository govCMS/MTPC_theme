    ...
    $.anythingSlider = function(el, options) {
        ...
        base.updateSlider = function() {
            ...
            if (base.options.resizeContents) {
                if (base.options.width) {
                    base.$wrapper.add(base.$items).css('width', base.options.width);
                }
                ...
                if (base.options.resizeContents) {
                    ...
                    if (c.length === 1) {
                        ...
                        if (c[0].tagName === "OBJECT") {
                            c.find('embed').andSelf().attr({ width: '100%', height: '100%' });
                        }
                    }
                } else {
        ...
        base.gotoPage = function(page, autoplay, callback) {
            ...
            base.$window.filter(':not(:animated)').animate(
                    ...
                    { queue: false, duration: base.options.animationTime, easing: base.options.easing, complete: function() {
