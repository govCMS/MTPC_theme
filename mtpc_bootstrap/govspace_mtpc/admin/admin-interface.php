...
<div class="wrap" id="of_container">
    ...
    <form action="" enctype="multipart/form-data" id="ofform">
        <div id="header">
            <div class="logo">
                ...
                <p>For future updates follow me <a href="http://themeforest.net/user/madza/follow">@themeforest</a> or
                    <a target="_blank" href="http://twitter.com/#!/madzathemes">@twitter</a></p>
            </div>
        ...
        <div class="save_bar_top">
            <img style="display:none" src="<?php get_stylesheet_directory_uri(); ?>/admin/images/loading-bottom.gif"
    ...
    <input name="reset" type="submit" value="Reset Options" class="button submit-button reset-button"
...
function of_load_only()
{
    ...
    ?>
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Droid+Sans"><?php
    ...
    foreach ($options as $value) {
        ...
        switch ($value['type']) {
            ...
            case "typography_description":
                ...
                /* Font Size */
                $val = $default['size'];
                if ($typography_description_stored['size'] != "") {
                    $val = $typography_description_stored['size'];
                }
                $output .= '<select class="of-typography of-typography-size" name="' . $value['id'] . '_size" id="' . $value['id'] . '_size">';
                for ($i = 9; $i < 13; $i++) {
                    if ($val == $i) {
                ...
                /* Font Weight */
                $val = $default['style'];
                if ($typography_description_stored['style'] != "") {
                    $val = $typography_description_stored['style'];
                }
                $normal = '';
                $italic = '';
                $bold = '';
                ...
                /* Font Color */
                $val = $default['color'];
                if ($typography_description_stored['color'] != "") {
                    $val = $typography_description_stored['color'];
                }
                $output .= '<div id="' . $value['id'] . '_color_picker" class="colorSelector"><div></div></div>';
                $output .= '<input class="of-color of-typography of-typography-color" name="' . $value['id'] . '_color" id="' . $value['id'] . '_color" type="text" value="' . $val . '" />';
            ...
            case "headings":
                ...
                /* Heading Color */
                $val = $default['color'];
                if ($heading_stored['color'] != "") {
                    $val = $heading_stored['color'];
                }
                $output .= '<div id="' . $value['id'] . '_color_picker" class="colorSelector"><div></div></div>';
                $output .= '<input class="of-color of-border of-border-color" name="' . $value['id'] . '_color" id="' . $value['id'] . '_color" type="text" value="' . $val . '" />';
                ...
                if ($heading_stored['fonttype'] != "") {
                    $val = $heading_stored['fonttype'];
                }
                $f1 = '';
                $f2 = '';
                $f3 = '';
                ...
                $f12 = '';
                $f13 = '';
                if ($val == 'PT Sans Narrow') {
                    $f13 = 'selected="selected"';
                }
                if ($val == 'ColaborateLight') {
                    $f1 = 'selected="selected"';
                }
                if ($val == 'Colaborate-Regular') {
                    $f2 = 'selected="selected"';
                }
                if ($val == 'Diavlo Book') {
                    $f3 = 'selected="selected"';
                }
                if ($val == 'Aller Light') {
                    $f4 = 'selected="selected"';
                }
                if ($val == 'Marketing Script') {
                    $f5 = 'selected="selected"';
                }
                if ($val == 'NeoRetroDraw') {
                    $f6 = 'selected="selected"';
                }
                if ($val == 'NeoRetroFill') {
                    $f7 = 'selected="selected"';
                }
                if ($val == 'Ubuntu-Title') {
                    $f8 = 'selected="selected"';
                }
                if ($val == 'UglyQua') {
                    $f9 = 'selected="selected"';
                }
                if ($val == 'Universal fruitcake') {
                    $f10 = 'selected="selected"';
                }
                if ($val == 'Yanone Kaffeesatz Light') {
                    $f11 = 'selected="selected"';
                }
                if ($val == 'Yanone Kaffeesatz Regular') {
                    $f12 = 'selected="selected"';
                }
            ...
            case "background":
                ...
                /* Background Repeate */
                $val = $default['repeate'];
                if ($background_stored['repeate'] != "") {
                    $val = $background_stored['repeate'];
                }
                $norepeat = '';
                $repeat = '';
                $repeatx = '';
